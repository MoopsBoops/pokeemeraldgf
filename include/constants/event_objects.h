...
#define OBJ_EVENT_GFX_AETHER_NORMAL               76
#define OBJ_EVENT_GFX_AETHER_MACH_BIKE            77
#define OBJ_EVENT_GFX_AETHER_SURFING              78
#define OBJ_EVENT_GFX_AETHER_FIELD_MOVE           79
